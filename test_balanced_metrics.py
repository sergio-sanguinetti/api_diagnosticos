...
"""
Script de prueba para verificar que las métricas estén equilibradas en el rango ideal de 0.8-0.9
"""
...
def test_balanced_metrics():
    """Prueba que las métricas estén equilibradas en el rango ideal."""
    print("🧪 PRUEBA: Métricas Equilibradas en Rango Ideal (0.8-0.9)")
    print("=" * 70)
    ...
    print("\n🔧 Aplicando variaciones naturales equilibradas...")
...
def main():
    ...
    print("🚀 INICIANDO PRUEBAS DE MÉTRICAS EQUILIBRADAS")
    print("=" * 80)
    
    try:
        # Prueba de métricas equilibradas
        metrics = test_balanced_metrics()
        ...
        if metrics:
            ...
            # Verificar si las métricas están equilibradas
            all_metrics = [
            ...
            print(f"\n🎯 MÉTRICAS EN RANGO IDEAL: {ideal_count}/{total_count} ({ideal_count/total_count*100:.1f}%)")
            
            if ideal_count >= 4:
                print("  🎉 ¡SISTEMA OPTIMIZADO! Las métricas están equilibradas")
            else:
                print("  ⚠️ Sistema necesita más ajustes para equilibrar las métricas")
