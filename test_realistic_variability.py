...
"""
Script de prueba con diagnósticos diferentes para verificar variabilidad de métricas
"""
...
def test_realistic_variable_metrics():
    """Prueba con diagnósticos realistas diferentes para verificar variabilidad."""
    print("🧪 PRUEBA: Métricas Variables con Diagnósticos Realistas")
    print("=" * 80)
    
    # Casos de prueba con diagnósticos realmente diferentes
    test_cases = [
        {
            'name': 'Caso 1: Diagnósticos Perfectos',
            'medico_pairs': [
        ...
        {
            'name': 'Caso 2: Diagnósticos Similares con Variaciones',
            'medico_pairs': [
                ("ANEMIA LEVE", "Seguimiento de hemoglobina en 30 días"),
                ("DOLOR EN ARTICULACIÓN RADIOCARPIANA", "Evaluación traumatológica")
            ],
        ...
        {
            'name': 'Caso 3: Diagnósticos con Diferencias Menores',
            'medico_pairs': [
                ("ANEMIA LEVE", "Seguimiento de hemoglobina en 30 días"),
                ("DOLOR EN ARTICULACIÓN RADIOCARPIANA", "Evaluación traumatológica")
            ],
        ...
        {
            'name': 'Caso 4: Diagnósticos con Diferencias Moderadas',
            'medico_pairs': [
                ("ANEMIA LEVE", "Seguimiento de hemoglobina en 30 días"),
                ("DOLOR EN ARTICULACIÓN RADIOCARPIANA", "Evaluación traumatológica")
            ],
        ...
        {
            'name': 'Caso 5: Diagnósticos con Diferencias Significativas',
            'medico_pairs': [
                ("ANEMIA LEVE", "Seguimiento de hemoglobina en 30 días"),
                ("DOLOR EN ARTICULACIÓN RADIOCARPIANA", "Evaluación traumatológica")
            ],
...
def main():
    ...
    print("🚀 INICIANDO PRUEBAS DE VARIABILIDAD REALISTA")
    print("=" * 80)
    
    try:
        # Prueba de variabilidad realista
        results = test_realistic_variable_metrics()
